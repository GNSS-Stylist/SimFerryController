...
Eigen::Transform<double, 3, Eigen::Affine> LOSolver::changeAxesConvention(const Eigen::Transform<double, 3, Eigen::Affine>& source, const AxesConventionConversion& conv)
{
    ...
    out.matrix() <<
            ...
            source(conv.fromIndex[0], conv.fromIndex[1]) * conv.multiplier[1],
            source(conv.fromIndex[0], conv.fromIndex[2]) * conv.multiplier[2],
            source(conv.fromIndex[0], 3) * conv.multiplier[0],

            source(conv.fromIndex[1], conv.fromIndex[0]) * conv.multiplier[0],
            source(conv.fromIndex[1], conv.fromIndex[1]) * conv.multiplier[1],
            source(conv.fromIndex[1], conv.fromIndex[2]) * conv.multiplier[2],
            source(conv.fromIndex[1], 3) * conv.multiplier[1],

            source(conv.fromIndex[2], conv.fromIndex[0]) * conv.multiplier[0],
            source(conv.fromIndex[2], conv.fromIndex[1]) * conv.multiplier[1],
